...
export const DOCUMENT_TYPES = {
    ...
    bbbee_cert: {
        ...
        fields: [
            ...
            { key: "black_ownership_percent", label: "Black Ownership %", type: "text", required: false, validationRegex: "^\\d{1,3}(\\.\\d+)?\\s*%?$", validationMessage: "Enter valid percentage (e.g. 51 or 51%)" },
            { key: "entity_name", label: "Entity Name", type: "text", required: false },
