-- Migration: Production Security Hardening V3 (Final)
...
BEGIN
    ...
    LOOP
        EXECUTE format('DROP POLICY "%s" ON public.templates;', pol_row.policyname);
    END LOOP;
END $$;
...
BEGIN
    ...
    LOOP
        EXECUTE format('DROP POLICY "%s" ON public.error_logs;', pol_row.policyname);
    END LOOP;
END $$;
