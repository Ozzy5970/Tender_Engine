-- MASTER SYNC V3.1: Frontend Contract Alignment, Security Hardening & Compatibility
-- Generated at: 2026-02-07
-- Description: Standardizes names (v3.1 Patch: Fix doc_type enum, Harden RLS, Null-safe Admin Sync)
...
-- NOTE: doc_type is assumed to exist as enum or text. We do NOT force add it as text to avoid breaking enum types.
